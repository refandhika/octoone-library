 ...
 */
class Translator extends TranslatorBase implements TranslatorInterface
{
     ...
     */
    public function trans(?string $key, array $replace = [], ?string $domain = 'messages', ?string $locale = null): string
    {
        if($key === null){
            return '';
        }
     ...
     * @return string
     */
    public function transChoice(string $key, int $number, array $replace = [], ?string $domain = 'messages', ?string $locale = null)
    {
    ...
    public function choice($key, $number, array $replace = [], $locale = null)
    {
        $line = $this->get(
            $key,
            $replace,
            $locale = $this->localeForChoice($number, $locale)
        );
